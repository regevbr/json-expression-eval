...
export type MyRule = Rule<Payload, RuleFunction, ExpressionContext, ExpressionFunction, Ignore>;
export const engine = new RulesEngine<Payload, ExpressionContext, RuleFunction, ExpressionFunction, Ignore>
